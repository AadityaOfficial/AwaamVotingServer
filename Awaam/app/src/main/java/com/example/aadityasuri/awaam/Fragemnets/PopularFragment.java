...
public class PopularFragment extends Fragment{
    String electionUrl2 = "http://aaditya21396.pythonanywhere.com/elections";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!electionUrl2.contains("Organisation")) {
            electionUrl2= electionUrl2 + "/" + selectedOrg;
        }
        View rootView = inflater.inflate(R.layout.popular_layout, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.recycler_list_popular);
        rv.setHasFixedSize(true);
        JsonObjectRequest getRequest = new JsonObjectRequest(Request.Method.GET, electionUrl2, null,
